...
void Program::createFromFiles(std::string vertexLocation, std::string geometryLocation, std::string fragmentLocation)
{
	std::string vertexString = readFile(vertexLocation);
	std::string fragmentString = readFile(fragmentLocation);
...
void Program::compileShader(std::string vertexCode, std::string geometryCode, std::string fragmentCode)
{
	_programID = glCreateProgram();
	...
	addShader(_programID, vertexCode, GL_VERTEX_SHADER);
	addShader(_programID, geometryCode, GL_GEOMETRY_SHADER);
	addShader(_programID, fragmentCode, GL_FRAGMENT_SHADER);
